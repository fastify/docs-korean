...
🎉 잘 하셨습니다. 이제 여러분은 각 경로에 대한 인터페이스를 정의하고, 엄격하게 타입이 적용된 request 및 response 인스턴스를 가질 수 있습니다. Fastify 타입 시스템의 다른 부분도 제네릭 속성에 의존합니다. 사용 가능한 항목에 대해 더 알아보려면 아래의 자세한 타입 시스템 문서를 참고하세요.
